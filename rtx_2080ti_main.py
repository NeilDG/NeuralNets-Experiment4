...
def train_depth():
    os.system("python3 \"train_main.py\" --server_config=2 --img_to_load=-1 "
...
def test_depth():
    os.system("python3 \"test_main.py\" --server_config=2 --img_to_load=-1 --plot_enabled=1 --network_version=\"depth_v01.04\" "
              "--iteration=12")

def train_img2img():
    os.system("python3 \"train_img2img_main.py\" --server_config=2 --img_to_load=-1 "
